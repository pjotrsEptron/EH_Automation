...
{
    public class deleteContact : SetupSteps

    {

        public IWebDriver driver;
        private string checkContactNotDeleted;
        ...
        public void pressDeletButtonInContact()
        {
            ...
            checkContactNotDeleted = find(By.XPath("/html/body/div[3]/div/div/div[1]/div/span")).Text;
        ...
        public void pressDeleteContactNO()
        {

            // press delete button NO
            find(By.XPath("/html/body/div[3]/div/div/div/div[2]/button[2]"))
                .Click();
        }

        public void contactNOTdeleted()
        {
            // click to search
            ...
            find(By.XPath("/html/body/div/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[2]/div[1]/div[2]/div/label/input"))
                .SendKeys(checkContactNotDeleted);

            Assert.IsTrue(checkContactNotDeleted.Equals(Question));
